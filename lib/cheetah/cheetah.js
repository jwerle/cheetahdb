...
Cheetah.Model         = Cheetah.prototype.Model           = require('./model').Model;
Cheetah.createModel   = Cheetah.prototype.createModel     = require('./model').createModel;
Cheetah.isModel       = Cheetah.prototype.isModel 		    = require('./model').isModel;
